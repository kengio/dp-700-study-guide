...
A browser-based quiz for the DP-700 practice + mock-exam question files in this repo. Tracks your attempts in `localStorage` and surfaces questions you've gotten wrong recently (adaptive mode), without sending anything to a server.
...
- **Per-bank localStorage state**: your progress for each bank (practice + Mock 1 + Mock 2 + Mock 3) is kept independently. No cross-device sync — `Export progress (JSON)` downloads it if you want to back it up or move it.
...
**4 banks · 232 questions total**

| Bank | Source | Q |
| :--- | :--- | :---: |
| Practice questions | `certification/resources/practice-questions/` | 82 |
...
| Mock Exam 3 | `certification/resources/mock-exam-3/questions.md` | 50 |

The practice bank covers all three exam domains in a single drillable set. The three mock exams mirror the full-length 50-question / 100-minute format with a 5-question case-study block at the end of each.

## How to run

### Live version

**[https://kengio.github.io/dp-700-study-guide/](https://kengio.github.io/dp-700-study-guide/)**
...
- `certification/resources/mock-exam/**`, `mock-exam-2/**`, or `mock-exam-3/**` — source markdown for the mock banks
...
- All state lives in your browser's `localStorage` under keys like `dp700-practice-dp-700`.
...
- The 82 practice questions live alongside, not inside, the 150 mock-exam questions. The mocks remain the canonical end-to-end exam simulation; this practice app is for between-mock drilling.
