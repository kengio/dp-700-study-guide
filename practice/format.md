...
certification/resources/mock-exam-3/questions.md              # Mock Exam 3
```
...
tags: [dp-700, practice-questions, implement-manage]
---
...
{
  "cert": "dp-700",
  "certTitle": "DP-700: Implementing Data Engineering Solutions Using Microsoft Fabric",
  ...
  "domains": [
    {
      ...
      "sourceFile": "certification/resources/practice-questions/01-implement-manage.md",
      "questionCount": 18
    }
  ...
  "questions": [
    {
      "id": "practice-questions-01-implement-manage-q001",
      "domain": "implement-manage",
      "title": "Choosing Between Dataflow Gen2 and a Pipeline",
      "difficulty": "medium",
      "question": "A data engineer needs to orchestrate a nightly batch load with conditional branching…",
      "choices": {
        "A": "A Dataflow Gen2",
        "B": "A Data pipeline",
        "C": "A notebook scheduled via a workspace trigger",
        "D": "An Eventstream"
      },
      "correctAnswer": "B",
      "shortAnswer": "A data pipeline is the right tool for conditional, multi-activity orchestration.",
      "explanation": "A **data pipeline** provides native control-flow activities (If Condition, ForEach, Until)…"
    }
...
For mock-exam banks, the output adds `"kind": "mock"` and `"sourceCert": "dp-700"` at the top level.
...
Same reasoning as the anki deck system planned for `certification/resources/anki/`:
