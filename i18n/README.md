---
title: "DP-700 Study Guide — Translations"
type: i18n-index
tags:
  - dp-700
  - i18n
...
Community translations of the DP-700 study guide. The English content under `certification/` is canonical; each locale's tree mirrors it.
...
1. `certification/dp-700-overview.md`
...
6. Orchestration + streaming topic files (`04-orchestration/`, `08-streaming-data/`) since Real-Time Intelligence ships fastest
