...
| 36 | A Longer-Term View of Ingestion Failure Trends | Resolve real-time errors | [03-realtime-errors.md](../../10-error-resolution/03-realtime-errors.md) | [monitoring-surfaces](../cheat-sheets/monitoring-surfaces-quick-ref.md) |
