...
- **Tab Size**: Set to 4 spaces, standard for PySpark, T-SQL, and KQL code.
...
```text
Summarise the key concepts from my notes on incremental loading patterns.
Generate 5 practice questions from my notes on OneLake security.
What are the differences between Dataflows Gen2 and pipelines based on my notes?
Quiz me on medallion architecture in a Fabric lakehouse.
Explain Real-Time Intelligence as if I am preparing for the DP-700 exam.
```
