<!--
Thanks for contributing to the DP-700 study guide.
...
- [ ] New mock-exam question / case-study block
- [ ] Topic-file expansion or rewrite
- [ ] New cheat sheet or worked example
- [ ] Blueprint refresh (Microsoft updated the skills-measured page)
- [ ] Tooling / repo housekeeping (CI, templates, etc.)

## Blueprint alignment

<!--
For factual corrections, new questions, or topic edits — link the supporting Microsoft Learn page.
This is required for content changes. See CONTRIBUTING.md "Ground rules".
-->

- Microsoft Learn source:
- Blueprint bullet this maps to (paste the exact text):

## Same error / same topic in other files?
...
- [ ] For blueprint refreshes: also updated the "What's New" callout, `final-review.md`, blueprint-date badge in README, and `CHANGELOG.md`
